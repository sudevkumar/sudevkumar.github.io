    ...
    <div className="project-containers">
      ...
      <div className="project-container">
        ...
        <div className="project-card">
          ...
          <div className="project-details">
            <p>
              This is a clone of Best Buy.com. This is a group project. We have
              a 5 members of team and I took resonsibity for Home page, Navbar
              and Footer. Except that I have also Worked on different components
              of this projecct to help my colleagues.
            </p>
            <h5>
              Tech Stack : <br />
              <li>HTML5</li>
        ...
        <div className="project-card">
          ...
          <div className="project-details">
            <p>
              This is a Star War web-site clone. This is a solo project where a
              user can seach for any star war avtars and also can find the
        ...
        <div className="project-card">
          ...
          <h2 className="project-title">Sudev's Mart E-Commerce WebSIte</h2>
          <div className="project-details">
            <p>
              This is a solo project using React Js, Redux and Bootstrap. I have
              used local storage to store user Signin and Login data. I took 3
